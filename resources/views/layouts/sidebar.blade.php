        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview" style="height: auto;">
                ...
                <ul class="treeview-menu" style="">
                    ...
                    <li><a href="{{url('persediaan/stok-keluar')}}"><i class="fa fa-circle-o"></i> Stok Keluar</a></li>
                    <li><a href="{{url('persediaan/stok-opname')}}"><i class="fa fa-circle-o"></i> Stok Opname</a></li>
                </ul>
            </li>
            ...
            <li>
                <a href="{{ route('transaksi.index') }}">
                    <i class="fa fa-cart-arrow-down"></i> <span>Transaksi Jual</span>
                </a>
            </li>
