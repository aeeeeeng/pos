...
<!-- Mirrored from themesbrand.com/minia/layouts/pages-starter.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jan 2022 06:27:11 GMT -->
    ...
    <!-- <body data-layout="horizontal"> -->
        ...
        <div id="layout-wrapper">
            ...
            @includeIf('app.layouts.header')
            @includeIf('app.layouts.sidebar')
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            @section('breadcrumb')
                                                <li class="breadcrumb-item"><a href="{{ url('app/beranda') }}">Beranda</a></li>
                                            @show
                                        </ol>
                                    </div>
        ...
        <script>
            ...
            function formatDateIsoFlatP(date)
            {
                var d = new Date(date),
                    month = '' + (d.getMonth() + 1),
                    day = '' + d.getDate(),
