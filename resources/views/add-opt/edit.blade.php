<div class="row">
    ...
    <script>
        ...
        {
            opsiTambahan.group = header.nama_add_opt;
            opsiTambahan.punya_bahan_baku = header.punya_bahan_baku;
            opsiTambahan.detail = details;
            $("#nama_group").val(opsiTambahan.group);
            $("#punya_bahan_baku").prop('checked', opsiTambahan.punya_bahan_baku);
        ...
        function simpanAddOpt(that)
        {
            ...
            $.ajax({
                url: `{{url('add-opt/update')}}/` + header.id_add_opt,
                method: 'post',
                dataType: 'json',
